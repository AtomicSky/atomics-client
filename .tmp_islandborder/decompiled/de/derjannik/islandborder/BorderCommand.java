...
TabCompleter {
    private static final List<String> SUBCOMMANDS = Arrays.asList("help", "info", "reload", "toggle", "pos1", "pos2", "setworld", "setouter", "setdivider", "enforcedivider", "layers", "protection");
    ...
    public BorderCommand(IslandBorderPlugin plugin, BorderConfig config) {
        this.plugin = plugin;
        this.config = config;
    }
                    ...
                    block6: {
                        block5: {
                            block4: {
                                ...
                                if (args.length != 2 || !args[0].equalsIgnoreCase("setdivider")) break block4;
                                completions.addAll(Arrays.asList("x", "z"));
                                break block3;
                            }
                            if (args.length != 2 || !args[0].equalsIgnoreCase("enforcedivider") && !args[0].equalsIgnoreCase("protection")) break block5;
                            completions.addAll(Arrays.asList("true", "false"));
                            break block3;
                        }
                        if (args.length != 2 || !args[0].equalsIgnoreCase("layers")) break block6;
                        completions.addAll(Arrays.asList("0", "1", "2", "3", "4"));
                        break block3;
                    }
                    if (args.length != 3 || !args[0].equalsIgnoreCase("layers")) break block7;
                    completions.addAll(Arrays.asList("1", "1.5", "2", "3"));
                    break block3;
                }
                if (args.length != 4 || !args[0].equalsIgnoreCase("layers")) break block8;
                completions.addAll(Arrays.asList("8", "12", "16", "24"));
                break block3;
            }
            if (args.length != 2 || !args[0].equalsIgnoreCase("setworld")) break block3;
            for (World world : Bukkit.getWorlds()) {
