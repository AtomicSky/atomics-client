...
public class AtomicsClientScreen extends Screen {
    ...
    public boolean charTyped(char codePoint, int modifiers) {
        if (settingsSearchFocused && settingsSearchField != null && settingsSearchField.charTyped(codePoint, modifiers)) {
            return true;
        }
    ...
    private void renderPreviewPanel(GuiGraphics context, int mouseX, int mouseY) {
        ...
        context.fill(x, boxTop, x + w, boxTop + 1, 0x90FFFFFF);
        context.fill(x, boxBottom - 1, x + w, boxBottom, 0x90FFFFFF);
        context.fill(x, boxTop, x + 1, boxBottom, 0x90FFFFFF);
        context.fill(x + w - 1, boxTop, x + w, boxBottom, 0x90FFFFFF);
        ...
        if (client.player != null && selectedTab == Tab.TOTEM) {
            ...
            InventoryScreen.renderEntityInInventoryFollowsMouse(context, (entityLeft + entityRight) / 2, entityBottom, entitySize, mouseX, mouseY, client.player);
